...
You can download or view the full documentation [here](https://github.com/mustafaalkan64/Eshop-Microservice/blob/master/docs/Microservices%2BRemastered.pdf).
...
* [.Net Core 9 or later](https://dotnet.microsoft.com/download/dotnet-core/9)
